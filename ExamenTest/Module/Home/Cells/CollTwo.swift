...
import UIKit
internal class collTwo: UICollectionViewCell {
    ...
    public static let identifier: String = "CollTwo"
    ...
    fileprivate func setupConstraints() {
        NSLayoutConstraint.activate([
            ...
            imageView.leadingAnchor.constraint(equalTo: containerMain.leadingAnchor,constant: 2),
            imageView.trailingAnchor.constraint(equalTo: containerMain.trailingAnchor,constant: -2),
